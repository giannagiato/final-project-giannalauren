...
function AttractionDetail() {
  ...
  return (
    <div>
      ...
      {attraction.website && <p><a href={attraction.website} target="_blank" rel="noopener noreferrer">Website</a></p>}
      {attraction.url && <p><a href={attraction.url} target="_blank" rel="noopener noreferrer">More Info</a></p>}
      <h3>Reviews:</h3>
      {attraction.reviews ? (
        <ul>
